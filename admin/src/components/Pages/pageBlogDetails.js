                        ...
                        <div className="card">
                            ...
                            <div className="body">
                                <table className="table card-table mb-0">
                                    <tbody>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">November 2018</a></td>
                                            <td className="text-right">( 42 )</td>
                                        </tr>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">December 2018</a></td>
                                            <td className="text-right">( 210 )</td>
                                        </tr>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">January 2019</a></td>
                                            <td className="text-right">( 54 )</td>
                                        </tr>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">February 2019</a></td>
                                            <td className="text-right">( 25 )</td>
                                        </tr>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">March 2019</a></td>
                                            <td className="text-right">( 102 )</td>
                                        </tr>
                                        <tr>
                                            <td className="font-weight-bold"><a className="text-muted" href="#">April 2019</a></td>
