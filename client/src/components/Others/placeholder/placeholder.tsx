...
export const ProductCardLoader = (props: any) => (
    <ContentLoader
        speed={2}
...
export const SidebarMobileLoader = (props: JSX.IntrinsicAttributes) => (
    <ContentLoader
        ...
        {...props}
    >
        <rect x="0" y="0" rx="26" ry="26" width="100%" height="46"/>
    </ContentLoader>
);
...
export const StoreNavLoader = (props: JSX.IntrinsicAttributes & IContentLoaderProps & { children?: React.ReactNode; }) => (
    <ContentLoader
        speed={2}
        width={974}
        height={49}
        ...
        {...props}
    >
        <rect x="16" y="12" rx="0" ry="0" width="90" height="49"/>
        <rect x="125" y="13" rx="0" ry="0" width="90" height="49"/>
        <rect x="485" y="12" rx="0" ry="0" width="90" height="49"/>
        <rect x="362" y="12" rx="0" ry="0" width="90" height="49"/>
        <rect x="249" y="12" rx="0" ry="0" width="90" height="49"/>
    </ContentLoader>
)
